...
public class ORDSTests {
    ...
    public void getOneEmployee() {
        ...
        //path parameters are used to retrieve specific rdsource: for expample 1 employee not all of them
        //{id} - path variable, that will be replace with a value after comma
        //after when() we specify HTTP request type/method/verb
        //The path parameters, E.g. if path is "/book/{hotelID}/{roomNumber}" you can do
